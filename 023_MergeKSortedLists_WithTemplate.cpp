...
class Solution {
  public:
    ...
    template<typename _Tp, typename _Container = vector<_Tp>, typename _Cmp = less<typename _Container::value_type> >
    ...
    ListNode* mergeKLists(vector<ListNode*>& lists) {
        ...
        priorityQueue<ListNode*, vector<ListNode*>, ListNodeCmp> pq;
